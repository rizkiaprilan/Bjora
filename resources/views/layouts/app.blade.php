                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @elseif(Auth::user()->role == 'member')
                            ...
                            <li class="nav-item">
                                <a href="/MyQuestion/{{Auth::user()->id}}/viewmessage" class="nav-link">
                        ...
                        @elseif(Auth::user()->role == 'admin')
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{route('Question.index')}}">Question</a>
                                    <a class="dropdown-item" href="{{route('Topic.index')}}">Topic</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item"
                                       href="/MyQuestion/{{Auth::user()->id}}/viewprofile">{{ __('Profile') }}</a>
